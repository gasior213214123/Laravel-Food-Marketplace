        ...
        <div class="col-md-8">
            <div class="card">            
                ...
                <div class="card-body">
                    ...
                    @endif
                    @foreach ($restaurant as $rst)
                        <div class="col-xs-8 col-xs-offset-2 slide-row row">
                            <div class="col-xs-1">
                                <a href="{{ url('/restaurants/' . $rst->id) }}"><img src="{{ url('restaurant-avatar/' . $rst->id . '/150') }}" alt="avatar" class="avatar img-thumbnail img-responsive rounded-circle"></a>
                            </div>
                            <div class="col-xs-7" style="padding-left: 15px;">
                                ...
                                <p>
                                    <i class="fas fa-unlock-alt"></i> Od {{ $rst->open_from }} | <i class="fas fa-lock"></i> Do {{ $rst->open_till }} | <i class="far fa-clock"></i> ok. {{ $rst->avg_wait }} min | <i class="fas fa-building"></i> {{ $rst->city }}
                                </p>
                            </div>
